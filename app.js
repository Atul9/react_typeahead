...
var FetchCountries = React.createClass({
add: function(event){
  if(event.target.value.length > 2){
    var result = SearchItemInArray(countries, event.target.value);
  }
},
render: function(){
  return(
...
ReactDOM.render(<FetchCountries />, document.getElementById('container'));
